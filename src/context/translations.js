export const translations = {
  en: {
    ...
    landing: {
      ...
      review_photo_label: "Your Photo (Optional)",
      review_photo_upload_text: "Click to upload a profile photo (JPG, PNG)",
      ...
      hero_badge_new: "✨ Pakistan's #1 AI Study OS • Federal, Punjab & Entry Tests",
      hero_ask_placeholder: "Ask any syllabus doubt... e.g., \"Newton's 2nd law in simple Urdu\"",
      hero_ask_btn: "Ask AI",
      hero_try_instant: "Try instant:",
      theme_light: "Light",
      theme_dark: "Dark",
  ...
  ur: {
    ...
    landing: {
      ...
      review_photo_label: "آپ کی تصویر (اختیاری)",
      review_photo_upload_text: "پروفائل تصویر اپلوڈ کرنے کیلئے کلک کریں (JPG, PNG)",
      review_photo_remove: "تصویر ہٹائیں",
      ...
      hero_badge_new: "✨ پاکستان کا نمبر 1 AI اسٹڈی پلیٹ فارم • فیڈرل، پنجاب اور انٹری ٹیسٹ",
      hero_ask_placeholder: "کوئی بھی سوال پوچھیں... جیسے 'نیوٹن کا قانون آسان اردو میں'، 'MDCAT بیالوجی'",
      hero_ask_btn: "AI سے پوچھیں",
      hero_try_instant: "آزمائیں:",
      theme_light: "لائٹ",
      theme_dark: "ڈارک",
